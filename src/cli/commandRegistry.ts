...
export const COMMAND_REGISTRY: CommandEntry[] = [
  ...
  { id: "start", name: "start", summary: "Detect and run the project start/dev command.", usage: "setupr start [target] [--tui|--plain]", mode: "both", allowsSubcommand: false, options: flagOptions("--plain, --no-tui", "--tui", "--smart", "--watch", "--force"), risk: "low", aiCapable: true },
  { id: "doctor", name: "doctor", summary: "Diagnose runtimes, dependencies, services, env files, git, and terminal support.", usage: "setupr doctor [--plain|--tui]", mode: "both", allowsSubcommand: false, options: flagOptions("--plain, --no-tui", "--tui", "--verbose") },
  ...
  { id: "deps", name: "deps", summary: "Show dependency tree and audit information.", usage: "setupr deps", mode: "plain", allowsSubcommand: false, aiCapable: true },
  ...
  { id: "logs", name: "logs", summary: "Show recent project logs.", usage: "setupr logs", mode: "plain", allowsSubcommand: false },
  { id: "test", name: "test", summary: "Run the project test script.", usage: "setupr test", mode: "plain", allowsSubcommand: false },
  ...
  { id: "git", name: "git", summary: "Git workflows, release helpers, hooks, branches, PRs, and history tools.", usage: "setupr git <command> [options]", mode: "plain", subcommands: ["init", "hooks", "flow", "commit", "branch", "pr", "stash", "rebase", "tag", "release", "status", "log", "sync", "clean", "ignore", "changelog", "blame", "cherry-pick", "worktree", "bisect", "contributors", "undo"].map((name) => ({ name, summary: `git ${name} workflow.` })), options: flagOptions("--force", "--smart", "--dry-run"), writes: true, aiCapable: true },
  ...
  { id: "plugin", name: "plugin", summary: "Install, remove, inspect, enable, or disable Setupr plugins.", usage: "setupr plugin <install|remove|list|info|enable|disable> [name-or-url]", mode: "plain", subcommands: ["install", "remove", "list", "info", "enable", "disable"].map((name) => ({ name, summary: `plugin ${name}.` })), writes: true },
